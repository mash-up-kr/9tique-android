package kr.co.mash_up.a9tique._old.ui.setting.agreement;
...
public class AgreementActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        mTvAgreementTitle.setText("전자상거래(인터넷사이버몰) 표준약관");
        mTvAgreementContent.setText("\n" + "제1조(목적)\n" +
                ...
                "\n제2조(정의)\n" +
                "① '몰'이란 9tique 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.\n" +
                "② '이용자'란 '몰'에 접속하여 이 약관에 따라 '몰'이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.\n" +
                "③ '회원'이라 함은 '몰'에 개인정보를 제공하여 회원등록을 한 자로서, '몰'의 정보를 지속적으로 제공받으며, '몰'이 제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다.\n" +
                "④ '비회원'이라 함은 회원에 가입하지 않고 '몰'이 제공하는 서비스를 이용하는 자를 말합니다.\n" +
                "\n제3조 (약관의 명시와 개정)\n" +
                "① '몰'은 이 약관의 내용과 상호, 영업소 소재지, 대표자의 성명, 사업자등록번호, 연락처(전화, 팩스, 전자우편 주소 등) 등을 이용자가 알 수 있도록 9tique 사이버몰의 초기 서비스화면(전면)에 게시합니다.\n" +
